...
public class AuthenticationController {
    ...
    @GetMapping("/register")
    public String displayerRegistrationForm (Model model) {
    ...
    public String processRegisterForm (@ModelAttribute @Valid RegisterDTO registerDTO,
        ...
        if (existingUser != null) {
            ...
            errors.rejectValue("username", "user.alreadyexists", "A user with that username already exists.");
            model.addAttribute("title", "Register");
